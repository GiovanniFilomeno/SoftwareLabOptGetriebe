function [length,max_curvature, curvature, collisionwith1, collisionwith2, collisionwithbauraum, collisionwithOtherEC1, collisionwithOtherEC2] = spline_connection_1 (pt1, pt2, pt3, pt4,EC1_center, EC2_center, EC1, EC2, bauraum, motor, otherEC1, otherEC2, cable_radius, radius_of_curvature)

collisionwith1 = 1;
collisionwith2 = 1;
collisionwithbauraum = 0;
collisionwithmotor = 1;
collisionwithOtherEC1 = 1;
collisionwithOtherEC2 = 1;
...
iteration = 0;
max_curvature = 0.5;
while (collisionwith1>0 || collisionwith2>0 || max_curvature<(1/radius_of_curvature) || collisionwithbauraum<1 || collisionwithmotor>0 || collisionwithOtherEC1>0 || collisionwithOtherEC2>0)
%xyz = [pt1; pt2; pt3; pt4];
...
collisionOtherEC2 = [];
    ...
    for i=1:Spline.pieces
            ...
            for t=t1:increment:t2
                ...
                collisionmotor(end+1) = inpolyhedron(motor, [x_t y_t z_t]);
                collisionOtherEC1(end+1) = inpolyhedron(otherEC1, [x_t y_t z_t]);
                collisionOtherEC2(end+1) = inpolyhedron(otherEC2, [x_t y_t z_t]);
...
collisionwithmotor = sum(collisionmotor)/size(collisionmotor,2)
collisionwithOtherEC1 = sum(collisionOtherEC1)/size(collisionOtherEC1,2)
collisionwithOtherEC2 = sum(collisionOtherEC2)/size(collisionOtherEC2,2)




    if (collisionwith1==0 && collisionwith2==0 && max_curvature>(1/radius_of_curvature) && collisionwithbauraum==0 && collisionwithmotor==1 && collisionwithOtherEC1==0 && collisionwithOtherEC2==0)
