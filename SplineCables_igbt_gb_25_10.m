...
rad_gb = EM_radius;
%pt3 mid spline
vector_pt1 = [EC1_center1(1)+(clearance_mid) EM_connection(2)+(-clearance_mid) EC1_center1(3)];
...
%im = [EM_connection; EM_connection+[0 -clearance_mid 0]; pt3; EC1_center2+[clearance_mid 0 0]; EC1_center2];
...
pt10 = EC1_center1 + [0 EC1_width/4 0];
pt15 = EC1_center1 + [0 -EC1_width/4 0];

pt9 = pt10 + [clearance_posy 0 0];
pt14 = pt15 + [clearance_negy 0 0];


%pt8 pos y spline
vector_pt3 = [pt9(1) EM_connection(2)+(-clearance_mid) EC1_center1(3)];
...
%pt13 neg y spline
vector_pt5 = [pt14(1) EM_connection(2)+(-clearance_mid) EC1_center1(3)];
...
[length,max_curvature, curvature, collisionwith1, collisionwithgb] = spline_connection_gb (EM_connection, EM_connection+[0 -clearance_mid 0], pt3, EC1_center1+[clearance_mid 0 0], EC1_center1, pt6, pt7, pt8, pt9, pt10, pt11, pt12, pt13, pt14, pt15,EC1_center, EM_start, EM_end, fv, EC1,  cable_radius, radius_of_curvature);
length
max_curvature
curvature;
collisionwith1;
