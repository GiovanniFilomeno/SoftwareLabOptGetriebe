function [length,max_curvature, curvature, collisionwith1, collisionwith2] = spline_connection (pt1, pt2, pt3, pt4,EC1_center, EC2_center, EC1, EC2)
...
iteration = 0;
max_curvature = 0.5;
while (collisionwith1>0 || collisionwith2>0 || max_curvature>0.3)
%xyz = [pt1; pt2; pt3; pt4];
...
collisionwith2 = sum(collision2)/size(collision2,2)
    ...
    if (collisionwith1==0 && collisionwith2==0 && max_curvature<=0.3)
        break;
    end
