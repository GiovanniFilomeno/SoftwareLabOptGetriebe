...
%             EC4_zmin = min(EC4.vertices(:,3));
            ...
            %pt3
            vector_pt1 = [EC1_center2(1) EM_connection(2)+(-clearance) EC1_center2(3)];
            ...
            im = [EM_connection; EM_connection+[0 -clearance 0]; pt3; EC1_center2+[0 -clearance 0]; EC1_center2];
...
%             text(x,y,z,[repmat('  ',4,1), num2str((1:4)')])
            ...
            ic = [EC1_center1; EC1_center1+[0 clearance 0]; EC2_center1+[0 clearance 0]; EC2_center1];
...
%             text(x,y,z,[repmat('  ',4,1), num2str((1:4)')])
            ...
            ce = [EC2_center2; EC2_center2+[0 -clearance 0]; EC3_center1+[0 clearance 0]; EC3_center1];
