function [length,max_curvature_mid, curvature_mid, collisionwith1_mid, collisionwithgb_mid] = spline_connection_gb (pt1, pt2, pt3, pt4, pt5, pt6, pt7, pt8, pt9, pt10, pt11, pt12, pt13, pt14, pt15, EC1_center, EM_start, EM_end, fv, EC1,  cable_radius, radius_of_curvature)
% igbt to motor
% 
%             im_spline = cscvn(im');
%             fnplt(im_spline,'y',2)
...
while (collisionwith1_mid>0 || collisionwithgb_mid>0.0072 || max_curvature_mid<(1/radius_of_curvature))
%xyz = [pt1; pt2; pt3; pt4];
...
collisionwithgb_mid = sum(collisiongb_mid)/size(collisiongb_mid,2)
    ...
    if (collisionwith1_mid==0 && collisionwithgb_mid==0.0071 && max_curvature_mid>(1/radius_of_curvature))
