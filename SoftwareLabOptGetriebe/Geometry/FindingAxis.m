...
% Function that reads the gearbox STL file and returns the coordinates and
% length of the gearbox shaft so it can be aligned with the bauraum later,
% as well as the dimensions and center of the gearbox's electric motor.
%
% :param str file: The name of the STL file located in the path folder
%
% :return: 
%   *[EM_start, EM_vector, Anchor, ElectricMotorRadius]*
%       - EM_start: Coordinates of the center of the electric motor.
%       - EM_vector: Vector pointing the direction of the gearbox.
%       - Anchor: Coordinates of a point at the center of the gearbox
%         shaft, which will be used for rotations.
%       - ElectricMotorRadius: Radius of the electric motor.
%
% :rtype: [ double array, double array, double array, double] 
%
% **Example in Code**
%
% .. code-block:: 
