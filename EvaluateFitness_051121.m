    ...
    if g == 4
        ...
        if Fitness(i,1) < 800
            ...
            if EC2_placement == 1   %Counterclockwise        
                ...
                [splinelength,max_curvature, curvature, collisionwith1, collisionwithgb] = spline_connection_gb (EM_connection, EM_connection+[0 -clearance_mid 0], pt3, EC1_SurfCenter(1,:)+[-clearance_mid 0 0], EC1_SurfCenter(1,:), pt6, pt7, pt8, pt9, pt10, pt11, pt12, pt13, pt14, pt15,EC1_center, EM_start, EM_end, gearbox, EC1,  cable_radius, radius_of_curvature);
